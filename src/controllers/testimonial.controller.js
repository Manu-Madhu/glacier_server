...
export const getTestimonialByIdCtrl = async (req, res) => {
    try {
        const { id } = req.params;
...
export const getManyTestimonialsCtrl = async (req, res, next) => {
    try {
...
export const updateTestimonialCtrl = async (req, res) => {
    try {
        const { id } = req.params;
...
export const deleteTestimonialCtrl = async (req, res) => {
    try {
        const { id } = req.params;
