...
export const createDiscount = async (obj) => {
    return await Discount.create(obj)
}

export const getDiscounts = async (filters, projects) => {
...
export const updateDiscount = async (id, obj) => {
    return await Discount.findByIdAndUpdate(id, obj, { new: true, runValidators: true });
}

export const addUserIdToCoupon = async (code, userId) => {
...
export const applyAutomaticDiscounts = async (items = []) => {
...
export const applyCouponDiscount = async (userId, couponCode = "", amount = 0) => {
...
export const applyAutoDiscountToAProduct = async (productId) => {
    let discountMessages = [];
